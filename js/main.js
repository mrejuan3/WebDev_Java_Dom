...
async function loadListings() {
  ...
  listings.slice(0, 50).forEach((listing) => {
    ...
    `;
    const rentBtn = col.querySelector('.btn-primary');
    rentBtn.addEventListener('click', onClickRent);
...
document.querySelector('#create-btn').addEventListener('click', onClickCreate);
document.querySelector('#cancel-btn').addEventListener('click', onClickCancel);
